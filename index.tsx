...
const AppLogo = () => (
  <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 transform transition-transform hover:scale-105">
    {/* Geometric Blue Logo matching the provided image */}
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
       <path d="M4 4L9 9M20 20L15 15" stroke="#3B82F6" strokeWidth="4" strokeLinecap="round" />
       <path d="M20 4L15 9M4 20L9 15" stroke="#3B82F6" strokeWidth="4" strokeLinecap="round" />
       <rect x="9" y="9" width="6" height="6" rx="1" stroke="#3B82F6" strokeWidth="3" />
    </svg>
  </div>
);
